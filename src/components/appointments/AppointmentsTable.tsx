      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            <th className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Appointment ID</th>
            <th className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Appointment Type</th>
            <th className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Calendar</th>
            <th className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Appointment Date</th>
            <th className="text-left text-xs font-semibold text-gray-500 uppercase tracking-wider px-5 py-3">Booking Date</th>
