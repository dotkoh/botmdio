...
export default function WebhookConnectModal({ open, provider, onClose, onConnect }: WebhookConnectModalProps) {
  ...
  // Generate a unique webhook URL + secret (stable for a given provider view)
  ...
  async function handleCopy(text: string, field: "url" | "secret") {
    ...
    >
      <div className="space-y-5">
        <p className="text-sm text-gray-500">
          Add this webhook URL to {provider.name}. All forms configured with this webhook will automatically appear in your Forms list.
        </p>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 px-4 py-3 bg-gray-50 dark:bg-[#182234] border border-gray-200 dark:border-[#263248] rounded-lg text-xs font-mono text-gray-700 dark:text-[#C7CFDB] break-all">
              {webhookUrl}
            </div>
            <button
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-3 py-3 rounded-lg text-sm transition-colors shrink-0"
            >
              {copiedField === "secret" ? <Check size={14} className="text-green-600" /> : <Copy size={14} />}
        ...
        <div className="bg-blue-50 dark:bg-[#151E3A] border border-blue-100 dark:border-[#1E3A6E] rounded-lg p-4">
          <p className="text-sm font-semibold text-[#111824] dark:text-[#F5F7FB] mb-2">
